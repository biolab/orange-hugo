...
![](/images/data/PaintData-stamped.png)
...
In the example below, we have painted a dataset with 4 classes. Such dataset is great for demonstrating k-means and hierarchical clustering methods. In the screenshot, we see that [k-Means](/widget-catalog/unsupervised/kmeansclustering), overall, recognizes clusters better than [Hierarchical Clustering](/widget-catalog/unsupervised/hierarchicalclustering). It returns a score rank, where the best score (the one with the highest value) means the most likely number of clusters. Hierarchical clustering, however, doesn’t group the right classes together. This is a great tool for learning and exploring statistical concepts.

![](/images/data/PaintData-Example.png)
