...
![](/images/evaluation/TestLearners-stamped.png)
...
4. The widget will compute a number of performance statistics:
   - Classification
   ![](/images/evaluation/TestLearners.png)
   ...
   - Regression
   ![](/images/evaluation/TestLearners-regression.png)
...
In a typical use of the widget, we give it a dataset and a few learning algorithms and we observe their performance in the table inside the **Test & Score** widget and in the [ROC](/widget-catalog/evaluation/rocanalysis). The data is often preprocessed before testing; in this case we did some manual feature selection ([Select Columns](/widget-catalog/data/selectcolumns) widget) on *Titanic* dataset, where we want to know only the sex and status of the survived and omit the age.

![](/images/evaluation/TestLearners-example-classification.png)

Another example of using this widget is presented in the documentation for the [Confusion Matrix](/widget-catalog/evaluation/confusionmatrix) widget.
