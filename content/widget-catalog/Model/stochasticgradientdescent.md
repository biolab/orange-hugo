...
![](/images/model/StochasticGradientDescent-stamped.png)
...
For the classification task, we will use *iris* dataset and test two models on it. We connected [Stochastic Gradient Descent](/widget-catalog/model/stochasticgradient) and [Tree](/widget-catalog/model/tree) to [Test & Score](/widget-catalog/evaluation/testandscore). We also connected [File](/widget-catalog/data/file) to **Test & Score** and observed model performance in the widget.

![](/images/model/StochasticGradientDescent-classification.png)

For the regression task, we will compare three different models to see which predict what kind of results. For the purpose of this example, the *housing* dataset is used. We connect the [File](/widget-catalog/data/file) widget to **Stochastic Gradient Descent**, [Linear Regression](/widget-catalog/model/linearregression) and [kNN](/widget-catalog/model/knn) widget and all four to the [Predictions](/widget-catalog/evaluation/predictions) widget.

![](/images/model/StochasticGradientDescent-regression.png)
